...
This project has been developed as part of the recommended project assigned for the course (Open Source Technologies) by my college, and **is not meant for production**, since it was developed in a span of about two weeks and thus **contains a lot of bad code** as I had a lot of other stuff to do. Yet, you are welcome to suggest any changes to this project and raise issue(s).
